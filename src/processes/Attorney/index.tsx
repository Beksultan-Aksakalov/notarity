...
export default function Attorney() {
    ...
    const [majorBirthDate, setMajorBirthDate] = useState<Date | null>(new Date());
    ...
    const onSend = (e: any) => {
        e.preventDefault();
        console.log("Доверитель\n"
            + "Фамилия " + majorLastname + "\n"
            + "Имя " + majorFirstname + "\n"
            + "Отчество " + majorMiddlename + "\n"
            + "ИИН/БИН " + majorIinBin + "\n"
            + "Дата рождения " + majorBirthDate?.toLocaleDateString() + "\n"
            + "Место рождения " + majorBirthPlace + "\n"
            + "Место проживания " + majorPlaceOfResidence + "\n"
            + "profit " + profit + "\n"
            + "docDate " + docDate?.toLocaleDateString() + "\n")

        attorneys.map((item, indec) => {
            console.log(
                "Доверенный\n"
                ...
                + "ИИН/БИН " + item.iinBin + "\n"
                + "Дата рождения " + item.birthDate?.toLocaleDateString() + "\n"
                + "Место рождения " + item.birthPlace + "\n"
                + "Место проживания " + item.placeOfResidence + "\n")
        })
    }
